...
public class Cangrejo implements IEnemigo {
	...
	public Cangrejo(double velocidad, int posX, int posY, int vida, int ancho, int alto, int direccion, String rutaImage, String rutaImage2) {
