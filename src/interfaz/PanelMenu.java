...
public class PanelMenu extends JPanel implements ActionListener {
	...
	public PanelMenu(InterfazSpaceInvaders interfaz) {
		...
		interfaz.setPreferredSize(new Dimension(1040, 880));
		//setPreferredSize(new Dimension(1040, 880)); //MODIFICADO DB: Probar tamaño de pantalla
		setLayout(null);
		//setOpaque(false);
		...
		space.setFont(new Font("ArcadeClassic", Font.PLAIN, 54)); //MODIFICADO DB: Tamaño de letra
