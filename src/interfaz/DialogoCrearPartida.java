	...
	public void actionPerformed(ActionEvent e) {
		...
		if (comando.equals(CANCELAR))
			...
			if (txtNombre.getText().equals(null) || txtNombre.getText().equals(""))
				JOptionPane.showMessageDialog(this, "Por favor ingrese un nombre válido", "Error al crear la partida",
						JOptionPane.ERROR_MESSAGE); //Mod DB: Acomodar el nombre de la ventana
			else {
